...
- **Scripts and Jupyter Notebooks**:
  ...
  - `MATLAB model/Figure_6B_S6_mean_levels.m`: MATLAB script for analysis and plots related to Figure 6B and Supplementary Figure 6.
  - `MATLAB model/Figure_6DE_real_rel_weights.m`: MATLAB script for analysis and plots related to Figure 6D and E.
