...
- **Scripts and Jupyter Notebooks**:
  ...
  - `Fig6_S4_S5.ipynb`: Analysis and plots for Figure 6 and Supplementary Figure 4 and 5.
  - `MATLAB model/Figure_7B_S6_mean_levels.m`: MATLAB script for analysis and plots related to Figure 7B and Supplementary Figure 6.
  - `MATLAB model/Figure_7DE_real_rel_weights.m`: MATLAB script for analysis and plots related to Figure 7D and E.
