...
tprint           (          ...
    'output_plots/Figure S6A - Rel Weights L1',   ...
    '-HR -eps -jpg',        ...
    pagesize);
...
tprint           (          ...
    'output_plots/Figure S6A - Abs Weights L1',   ...
    '-HR -eps -jpg',        ...
    pagesize);
...
tprint           (          ...
    'output_plots/Figure S6B - Rel Weights L3',   ...
    '-HR -eps -jpg',        ...
    pagesize);
...
tprint           (          ...
    'output_plots/Figure S6B - Abs Weights L3',   ...
    '-HR -eps -jpg',        ...
    pagesize);
...
set              (gca, ...
    ...
    'position',                [0.2 0.2 0.75 0.75]);
tprint           (          ...
    'output_plots/Figure 6 - morphologies',   ...
    '-HR -eps -jpg',        ...
    pagesize);
