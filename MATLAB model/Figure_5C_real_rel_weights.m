...
tprint           (          ...
    'output_plots/Figure 5E - Rel Weights L1vs L3',   ...
    '-HR -eps -jpg',        ...
    pagesize);
...
tprint           (          ...
    'output_plots/Figure 5F - Voltage L1 vs L3',   ...
    '-HR -eps -jpg',        ...
    pagesize);
...
tprint           (          ...
    'output_plots/Figure 5G - L1_L3 Voltage vs Rel Weights',   ...
    '-HR -eps -jpg',        ...
    pagesize);
...
tprint           (          ...
    'output_plots/Figure 5G - L1_L3 Voltage - Abs Weights',   ...
    '-HR -eps -jpg',        ...
    pagesize);
